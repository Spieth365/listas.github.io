...
// Enviar mensaje a Telegram usando cURL y guardar respuesta para diagnóstico
...
if (curl_errno($ch)) {
    file_put_contents("telegram_error.log", "cURL error: " . curl_error($ch) . "\n", FILE_APPEND);
} else {
    file_put_contents("telegram_error.log", "Telegram response: " . $response . "\n", FILE_APPEND);
}
curl_close($ch);
